...
document.addEventListener("DOMContentLoaded", function() {
	// Modal script from w3school example
    // Get the modal
    var modalOne = document.getElementById("modalAgreeOne");
	var modalTwo = document.getElementById("modalAgreeTwo");
	var modalThree = document.getElementById("modalAgreeThree");
	var modalFour = document.getElementById("modalAgreeFour");
	...
	linkOne.onclick = function() {
		console.log("click arrow 1");
		modalOne.style.display = "block";
	}

	linkTwo.onclick = function() {
		console.log("click arrow 2");
		modalTwo.style.display = "block";
	}

	linkThree.onclick = function() {
		console.log("click arrow 3");
		modalThree.style.display = "block";
	}

	linkFour.onclick = function() {
		console.log("click arrow 4");
	...
	inputPsw.addEventListener('focusout', function() {
		...
		if (!isTextExist) { // 텍스트가 존재하지 않으면 에러상태를 나타낸다.
			...
			document.getElementById("psw-check").classList.add("error-text");
